...
export const ProductivityPopover = ({ notifications = 0, className }: ProductivityPopoverProps) => {
  ...
  const getEntityTypeColor = (type: string) => {
    ...
    return typeColors[type as keyof typeof typeColors] || typeColors["report"]
  }
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100">Productivity Suite</h3>
              <p className="text-xs text-gray-600 dark:text-gray-400">Messages & Tasks</p>
            </div>
          </div>
          <Button
            variant="ghost"
        ...
        <Tabs defaultValue="messages" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mx-4 mt-3 mb-0 bg-gray-100 dark:bg-gray-800">
            <TabsTrigger
              value="messages"
              className="text-xs font-medium data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700"
            >
              ...
              {totalUnreadCount > 0 && (
                <Badge
                  variant="secondary"
                  className="ml-1.5 h-4 px-1.5 text-xs bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300"
                >
                  {totalUnreadCount}
                </Badge>
              )}
            ...
            <div className="px-4 pt-3">
              ...
              {sortedThreads.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">No message threads yet</p>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between mb-1">
                                ...
                                <div className="flex items-center space-x-1">
                                  {unreadCount > 0 && (
                                    <Badge className="h-4 px-1.5 text-xs bg-blue-500 text-white">{unreadCount}</Badge>
                                  )}
                              ...
                              {thread.linkedTo && (
                                <Badge
                                  variant="outline"
                                  className={cn("text-xs mb-1.5", getEntityTypeColor(thread.linkedTo.type))}
                                >
            ...
            <div className="px-4 pt-3">
              ...
              {sortedTasks.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Create your first task to get started</p>
                </div>
              ) : (
                <ScrollArea className="h-[280px] pr-2">
                  <div className="space-y-2">
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between mb-1">
                                ...
                                <div className="flex items-center space-x-1">
                                  {isNew && <Badge className="h-4 px-1.5 text-xs bg-emerald-500 text-white">NEW</Badge>}
                                  <AlertTriangle className={cn("w-3 h-3", getPriorityColor(task.priority))} />
                                </div>
                              </div>
                              ...
                              {task.linkedTo && (
                                <Badge
                                  variant="outline"
                                  className={cn("text-xs", getEntityTypeColor(task.linkedTo.type))}
                                >
                                  <ExternalLink className="w-2 h-2 mr-1" />
