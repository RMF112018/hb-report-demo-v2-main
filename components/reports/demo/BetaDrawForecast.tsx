...
interface BetaDrawForecastProps {
  projectData?: {
    name: string
    number: string
...
export function BetaDrawForecast({ projectData, userRole }: BetaDrawForecastProps) {
    ...
    <div className="bg-white text-black p-8 max-w-6xl mx-auto font-sans print:p-4 print:max-w-none">
      ...
      <div className="grid grid-cols-3 items-center mb-8 border-b-2 border-gray-300 pb-4">
        ...
        <div className="text-center">
          <h1 className="text-xl font-bold text-[#FA4616]">DRAW FORECAST</h1>
          <div className="text-sm text-[#0021A5] mt-1">
            {userRole === "project-manager" ? "Project Analysis" : "Portfolio Analysis"}
          </div>
        </div>
        <div className="text-right">
          <p className="text-sm font-medium text-[#0021A5]">{currentDate}</p>
        </div>
      </div>

      {/* Project Information Header with HB Colors */}
      <div className="mb-8">
        <div className="grid grid-cols-4 gap-4 text-sm">
          <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
            <strong className="text-[#0021A5]">Project Name:</strong>
            <div className="mt-1">{data.name}</div>
          </div>
          <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
            <strong className="text-[#FA4616]">Project Number:</strong>
            <div className="mt-1">{data.number}</div>
          </div>
          <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
            <strong className="text-[#0021A5]">Contract Value:</strong>
            <div className="mt-1">{data.contractValue}</div>
          </div>
          <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
            <strong className="text-[#FA4616]">Forecast Month:</strong>
            <div className="mt-1">{data.forecastMonth}</div>
          </div>
        </div>
      </div>

      {/* Draw Schedule Summary with HB Branding */}
      <div className="mb-8">
        <div className="bg-gradient-to-r from-blue-100 to-orange-100 p-3 mb-4 border border-gray-300 rounded-lg">
          <h2 className="font-bold text-lg text-[#0021A5]">1. Draw Schedule Summary</h2>
        </div>
        <div className="grid grid-cols-3 gap-8 text-sm">
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="mb-2">
              <strong className="text-[#0021A5]">Total Contract Value:</strong>
              <div className="font-semibold text-lg text-[#FA4616]">$57,235,491.00</div>
            </div>
            <div className="mb-2">
              <strong className="text-[#0021A5]">Total Draws to Date:</strong>
              <div className="font-semibold">$45,750,000.00</div>
            </div>
            <div className="mb-2">
              <strong className="text-[#0021A5]">Percentage Complete:</strong>
              <div className="font-semibold text-green-600">79.9%</div>
            </div>
          </div>
          <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
            <div className="mb-2">
              <strong className="text-[#FA4616]">Remaining Contract Value:</strong>
              <div className="font-semibold text-lg text-[#0021A5]">$11,485,491.00</div>
            </div>
            <div className="mb-2">
              <strong className="text-[#FA4616]">Projected Completion:</strong>
              <div className="font-semibold">December 2025</div>
            </div>
            <div className="mb-2">
              <strong className="text-[#FA4616]">Next Draw Amount:</strong>
              <div className="font-semibold text-orange-600">$7,900,000.00</div>
            </div>
          </div>
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="mb-2">
              <strong className="text-[#0021A5]">Average Monthly Draw:</strong>
              <div className="font-semibold">$5,225,000.00</div>
            </div>
            <div className="mb-2">
              <strong className="text-[#0021A5]">Variance to Budget:</strong>
              <div className="font-semibold text-green-600">-$150,000.00</div>
            </div>
            <div className="mb-2">
              <strong className="text-[#0021A5]">Cash Flow Status:</strong>
      ...
      {/* Monthly Draw Schedule Table with HB Branding */}
      <div className="mb-8">
        <div className="bg-gradient-to-r from-blue-100 to-orange-100 p-3 mb-4 border border-gray-300 rounded-lg">
          <h2 className="font-bold text-lg text-[#0021A5]">2. Monthly Draw Schedule</h2>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border border-gray-300 text-sm">
            <thead>
              <tr className="bg-gradient-to-r from-blue-200 to-orange-200">
                <th className="border border-gray-300 p-2 text-left text-[#0021A5]">Month</th>
                <th className="border border-gray-300 p-2 text-right text-[#0021A5]">Budgeted Amount</th>
                <th className="border border-gray-300 p-2 text-right text-[#0021A5]">Actual/Forecast</th>
                <th className="border border-gray-300 p-2 text-right text-[#0021A5]">Variance</th>
                <th className="border border-gray-300 p-2 text-right text-[#0021A5]">Cumulative Budget</th>
                <th className="border border-gray-300 p-2 text-right text-[#0021A5]">Cumulative Actual</th>
              </tr>
            </thead>
            <tbody>
              {drawSchedule.map((row, index) => (
                <tr key={index} className={index % 2 === 0 ? "bg-blue-50" : "bg-orange-50"}>
                  <td className="border border-gray-300 p-2 font-medium text-[#0021A5]">{row.month}</td>
      ...
      {/* Cash Flow Analysis with HB Branding */}
      <div className="mb-8">
        <div className="bg-gradient-to-r from-blue-100 to-orange-100 p-3 mb-4 border border-gray-300 rounded-lg">
          <h2 className="font-bold text-lg text-[#0021A5]">3. Cash Flow Analysis</h2>
        </div>
        <div className="grid grid-cols-2 gap-8 text-sm">
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="mb-4">
              <h3 className="font-semibold mb-2 text-[#0021A5]">Monthly Cash Flow Trends:</h3>
            ...
            <div className="mb-4">
              <h3 className="font-semibold mb-2 text-[#0021A5]">Risk Factors:</h3>
              <ul className="space-y-1 ml-4">
          ...
          <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
            <div className="mb-4">
              <h3 className="font-semibold mb-2 text-[#FA4616]">Key Milestones:</h3>
              <ul className="space-y-1 ml-4">
            ...
            <div className="mb-4">
              <h3 className="font-semibold mb-2 text-[#FA4616]">Optimization Opportunities:</h3>
              <ul className="space-y-1 ml-4">
      ...
      {/* Forecast Adjustments with HB Branding */}
      <div className="mb-8">
        <div className="bg-gradient-to-r from-blue-100 to-orange-100 p-3 mb-4 border border-gray-300 rounded-lg">
          <h2 className="font-bold text-lg text-[#0021A5]">4. Forecast Adjustments & Assumptions</h2>
        </div>
        <div className="text-sm">
          <p className="mb-4">
            <strong className="text-[#0021A5]">Key Assumptions for Draw Forecast:</strong>
          </p>
          ...
          <p className="mb-4">
            <strong className="text-[#FA4616]">Recent Adjustments Made:</strong>
          </p>
          <ul className="list-disc ml-6 space-y-1 mb-4">
          ...
          <p className="mb-4">
            <strong className="text-[#0021A5]">Contingency Planning:</strong>
          </p>
