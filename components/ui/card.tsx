...
>(({ className, variant = "default", elevation = "md", ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(baseClasses, variantClasses[variant], elevationClasses[elevation], className)}
      {...props}
    />
  )
})
...
>(({ className, variant = "default", ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn("flex flex-col space-y-1.5 p-4 sm:p-5 lg:p-6 rounded-t-xl", variantClasses[variant], className)}
      {...props}
    />
  )
})
