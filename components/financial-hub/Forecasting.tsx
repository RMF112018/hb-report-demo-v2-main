            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Alert className="border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950">
                ...
                <AlertDescription className="text-orange-800 dark:text-orange-200">
                  <strong>Market Volatility Alert:</strong> Construction material costs showing 8% increase trend. HBI
                  recommends adjusting Q4 forecasts accordingly.
                </AlertDescription>
              </Alert>
              ...
              <Alert className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950">
                ...
                <AlertDescription className="text-green-800 dark:text-green-200">
                  <strong>Labor Availability:</strong> Skilled trades showing improved availability Q2-Q3. Opportunity
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <div className="p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Predictive analysis shows 15% schedule risk reduction possible through proactive resource
                    reallocation in months 4-7.
                  </p>
                </div>
              </div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-medium text-gray-800 dark:text-gray-200">
                        Interactive HBI Agent Available
                      </span>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Select "HBI Forecast" for any cost code to engage with our AI agent for detailed analysis and
                      scenario planning.
                    </p>
                  </div>
