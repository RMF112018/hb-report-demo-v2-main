...
const PROJECT_SOURCES = ["CLIENT REQUEST", "RFQ", "DESIGN/BUILD RFP", "HARD BID", "LUMP SUM PROPOSAL"]
...
const PROJECT_STATUSES = ["ACTIVE", "ON HOLD", "PENDING", "AWARDED", "NOT AWARDED", "CLOSED"]

const CURRENT_STAGES = ["DD", "GMP", "CLOSED", "ON HOLD", "50% CD", "Schematic"]
  ...
  const handleSave = () => {
    const projectData = {
      ...
      presubmissionReview: formData.presubmissionReview
        ? new Date(formData.presubmissionReview).toISOString()
        : undefined,
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-[60vw] h-[90vh] flex flex-col z-[100]">
          <DialogHeader className="flex-shrink-0">
            <DialogTitle className="flex items-center gap-2">
              ...
              {formData.projectNumber && (
                <span className="text-sm text-muted-foreground font-normal">- {formData.projectNumber}</span>
              )}
            </DialogTitle>
          </DialogHeader>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Select
                            value={formData.source || "CLIENT REQUEST"}
                        ...
                        <div>
                          ...
                          <Select
                            value={formData.deliverable || "CONCEPTUAL EST"}
                            onValueChange={(value) => handleInputChange("deliverable", value)}
                          >
                            <SelectTrigger>
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <Select
                            value={formData.leadEstimator || "select"}
                            onValueChange={(value) =>
                              handleInputChange("leadEstimator", value === "select" ? "" : value)
                            }
                          >
                            <SelectTrigger>
                        ...
                        <div>
                          ...
                          <Select
                            value={formData.px || "none"}
                            onValueChange={(value) => handleInputChange("px", value === "none" ? "" : value)}
                          >
                            <SelectTrigger>
                      ...
                      {formData.status === "ACTIVE" && (
                        <div>
                          ...
                          <Select
                            value={formData.currentStage || "none"}
                            onValueChange={(value) => handleInputChange("currentStage", value === "none" ? "" : value)}
                          >
                            <SelectTrigger>
                    ...
                    <Card className="bg-gradient-to-r from-primary/5 to-primary/10 border-primary/20 dark:from-primary/10 dark:to-primary/5 dark:border-primary/30">
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground mb-4">
                          Access the comprehensive responsibility matrix to manage project deliverables, deadlines, and
                          team assignments.
                        </p>
                        <Button
                          variant="outline"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleInputChange("costPerGsf", e.target.value ? parseFloat(e.target.value) : undefined)
                            }
                            placeholder="0.00"
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleInputChange("costPerUnit", e.target.value ? parseFloat(e.target.value) : undefined)
                            }
                            placeholder="0.00"
                          />
                        </div>
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              ...
                              onCheckedChange={(checked) =>
                                handleChecklistChange("coordinateWithMarketing", checked as boolean)
                              }
                            />
          ...
          <div className="flex justify-between items-center gap-3 p-6 border-t bg-background flex-shrink-0">
            <div className="flex gap-3">{/* Empty space for left alignment */}</div>
