      ...
      <div className="h-full w-full max-w-full flex flex-col justify-center items-center px-8 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-full">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-5xl mx-auto mb-6">
              Cumulative costs vs savings over 40 quarters (10 years), with savings starting 6 months post-MVP deployment after onboarding and process transfer. Data based on HB Intel cost analysis with detailed quarterly breakdown.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              <svg width="100%" height="100%" viewBox="0 0 600 300" preserveAspectRatio="xMidYMid meet">
                ...
                <text x="50" y="270" fill="#ffffff80" fontSize="12">Q1-Q4</text>
                <text x="100" y="270" fill="#ffffff80" fontSize="12">Q5-Q8</text>
                <text x="150" y="270" fill="#ffffff80" fontSize="12">Q9-Q12</text>
                <text x="200" y="270" fill="#ffffff80" fontSize="12">Q13-Q16</text>
                <text x="250" y="270" fill="#ffffff80" fontSize="12">Q17-Q20</text>
                <text x="300" y="270" fill="#ffffff80" fontSize="12">Q21-Q24</text>
                <text x="350" y="270" fill="#ffffff80" fontSize="12">Q25-Q28</text>
                <text x="400" y="270" fill="#ffffff80" fontSize="12">Q29-Q32</text>
                <text x="450" y="270" fill="#ffffff80" fontSize="12">Q33-Q36</text>
                <text x="500" y="270" fill="#ffffff80" fontSize="12">Q37-Q40</text>
                <text x="550" y="270" fill="#ffffff80" fontSize="12">Y6</text>
                <text x="600" y="270" fill="#ffffff80" fontSize="12">Y7</text>
                <text x="650" y="270" fill="#ffffff80" fontSize="12">Y8</text>
                <text x="700" y="270" fill="#ffffff80" fontSize="12">Y9</text>

                {/* Costs Line (Red) */}
                <polyline
                  points="50,248 100,245 150,240 200,232 250,220 300,205 350,190 400,170 450,150 500,125 550,100 600,75"
                  fill="none"
                  stroke="red"
                  strokeWidth="3"
                />
                ...
                <polyline
                  points="50,250 100,250 150,235 200,210 250,175 300,125 350,80 400,35 450,-10 500,-55 550,-100 600,-150"
                  fill="none"
                  stroke="green"
                  strokeWidth="3"
                />
            ...
            <div className="relative z-10 overflow-x-auto bg-white/10 rounded-lg backdrop-blur-sm">
              <table className="min-w-full text-sm text-left text-blue-200">
                ...
                <tbody>
                  <tr>
                    <td className="px-4 py-2">Q1-Q4</td>
                    <td className="px-4 py-2">0.52</td>
                    <td className="px-4 py-2">0</td>
                    <td className="px-4 py-2">-0.52</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q5-Q8</td>
                    <td className="px-4 py-2">0.78</td>
                    <td className="px-4 py-2">3.15</td>
                    <td className="px-4 py-2">2.37</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q9-Q12</td>
                    <td className="px-4 py-2">1.05</td>
                    <td className="px-4 py-2">6.40</td>
                    <td className="px-4 py-2">5.35</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q13-Q16</td>
                    <td className="px-4 py-2">1.35</td>
                    <td className="px-4 py-2">9.75</td>
                    <td className="px-4 py-2">8.40</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q17-Q20</td>
                    <td className="px-4 py-2">1.68</td>
                    <td className="px-4 py-2">13.20</td>
                    <td className="px-4 py-2">11.52</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q21-Q24</td>
                    <td className="px-4 py-2">1.85</td>
                    <td className="px-4 py-2">16.80</td>
                    <td className="px-4 py-2">14.95</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q25-Q28</td>
                    <td className="px-4 py-2">1.92</td>
                    <td className="px-4 py-2">20.55</td>
                    <td className="px-4 py-2">18.63</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q29-Q32</td>
                    <td className="px-4 py-2">2.00</td>
                    <td className="px-4 py-2">24.45</td>
                    <td className="px-4 py-2">22.45</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q33-Q36</td>
                    <td className="px-4 py-2">2.08</td>
                    <td className="px-4 py-2">28.50</td>
                    <td className="px-4 py-2">26.42</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Q37-Q40</td>
                    <td className="px-4 py-2">2.17</td>
                    <td className="px-4 py-2">32.70</td>
                    <td className="px-4 py-2">30.53</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          >
            <p className="text-blue-200 text-sm">
              Projections based on HB Intel cost analysis with detailed quarterly forecast. Assumes 4% maintenance escalation post-Year 5, 2.5% annual savings growth. Savings delayed to post-deployment (Period 2 full realization after 6-month onboarding). Net turns positive in Period 2, reaching $30.53M by Period 10.
            </p>
          </motion.div>
        </div>
      </div>
