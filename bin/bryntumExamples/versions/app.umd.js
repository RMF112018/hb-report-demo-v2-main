...
const ProjectWebSocketHandlerMixin = Target => class extends (Target || Base) {
    ...
    doDestroy() {
        ...
        (_this$websocketManage = this.websocketManager) === null || _this$websocketManage === undefined || _this$websocketManage.destroy();
        super.doDestroy();
    }
    ...
    updateWsAddress(address) {
        ...
        const me = this;
        (_me$websocketManager = me.websocketManager) === null || _me$websocketManager === undefined || _me$websocketManager.destroy();
   ...
   */
    ...
    async handleRevisionNotification({
        ...
        if (me.isAutoSyncSuspended) {
            ...
            var _me$_queuedRevisions;
            const revisions = [];
            if ((_me$_queuedRevisions = me._queuedRevisions) !== null && _me$_queuedRevisions !== undefined && _me$_queuedRevisions.length) {
   ...
   */
    wsClose() {
        ...
        (_this$websocketManage2 = this.websocketManager) === null || _this$websocketManage2 === undefined || _this$websocketManage2.close();
    }

    resumeAutoSync() {
        var _me$_queuedRevisions2;
        const me = this;
        super.resumeAutoSync();
        if (!me.isAutoSyncSuspended && (_me$_queuedRevisions2 = me._queuedRevisions) !== null && _me$_queuedRevisions2 !== undefined && _me$_queuedRevisions2.length) {
...
class WebSocketHelper {
   ...
   */
    constructor(client, host) {
        ...
        if (autoLogin) {
            ...
            client.project.wsSend('login', {
                login : 'auto'
            }).then(() => client.project.wsProjectId = 1);
        }
    }
   ...
   */
    wsReceive(data) {
        var _data$data;
        const me = this,
            userName = data === null || data === undefined || (_data$data = data.data) === null || _data$data === undefined ? undefined : _data$data.userName;
        switch (data.command) {
...
class WebSocketManager extends Events(Base) {
    ...
    get isConnecting() {
        var _this$connector;
        return ((_this$connector = this.connector) === null || _this$connector === undefined ? undefined : _this$connector.readyState) === this.constructor.webSocketImplementation.CONNECTING;
    }

    get isOpened() {
        var _this$connector2;
        return ((_this$connector2 = this.connector) === null || _this$connector2 === undefined ? undefined : _this$connector2.readyState) === this.constructor.webSocketImplementation.OPEN;
    }

    get isClosing() {
        var _this$connector3;
        return ((_this$connector3 = this.connector) === null || _this$connector3 === undefined ? undefined : _this$connector3.readyState) === this.constructor.webSocketImplementation.CLOSING;
    }

    get isClosed() {
        var _this$connector4;
        return ((_this$connector4 = this.connector) === null || _this$connector4 === undefined ? undefined : _this$connector4.readyState) === this.constructor.webSocketImplementation.CLOSED;
    }
   ...
   */
    send(command, data = {}) {
        ...
        (_this$connector5 = this.connector) === null || _this$connector5 === undefined || _this$connector5.send(JSON.stringify({
            command,
            data
        }));
    }
