...
class ComplexityColumn extends Column {
    ...
    renderer({
        ...
        const {
            ...
            complexity = (_store$getById = store.getById(value)) === null || _store$getById === undefined ? undefined : _store$getById.text;
        return complexity ? [{
            tag       : 'i',
...
class ComplexityCombo extends Combo {
    ...
    syncInputFieldValue(...args) {
        ...
        const complexity = (_this$store$getById = this.store.getById(this.value)) === null || _this$store$getById === undefined ? undefined : _this$store$getById.text;
