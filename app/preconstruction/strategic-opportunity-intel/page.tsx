...
import { Target, Lightbulb, TrendingUp, Users, MapPin, Bell } from "lucide-react"
import { StrategicOpportunityGrid } from "../../../components/precon/StrategicOpportunityGrid"
import { StrategicOpportunityMapView } from "../../../components/precon/StrategicOpportunityMapView"
import { MarketWatchLeadGenPanel } from "../../../components/precon/MarketWatchLeadGenPanel"
...
/**
 * Strategic Opportunity Intel Page Component
 */
export default function StrategicOpportunityIntelPage() {
  const { user } = useAuth()
  ...
  // Get tabs for strategic opportunity intel content
  const getTabsForContent = (): PageHeaderTab[] => {
    return [
      ...
      { id: "hbi", label: "HBI Forecast Coach" },
    ]
  }
  ...
  const getHeaderConfig = () => {
    ...
    return {
      userName,
      moduleTitle: "Strategic Opportunity Intel",
      subHead: "Advanced intelligence and strategic insights for business development",
      ...
      navigationState: {
        ...
        currentViewType: "strategic-opportunity-intel",
                ...
                <CardContent>
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                      Advanced intelligence and strategic insights for business development. This module will provide
                      comprehensive market analysis, client intelligence, and strategic insights to drive business
                      growth.
                    </p>
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="text-center">
                        <TrendingUp className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                        <h4 className="font-medium text-gray-900 dark:text-white">Active Pipeline</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Track active opportunities and pipeline status
                        </p>
                      </div>
                      <div className="text-center">
                        <MapPin className="h-8 w-8 text-green-600 mx-auto mb-2" />
                        <h4 className="font-medium text-gray-900 dark:text-white">Map View</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div className="text-center">
                        ...
                        <h4 className="font-medium text-gray-900 dark:text-white">Opportunity Alerts</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Real-time alerts and notifications</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                ...
                <CardContent>
                  <div className="text-center py-8">
                    <p className="text-gray-600 dark:text-gray-400">Opportunity alerts features coming soon...</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          {activeTab === "hbi" && (
            <div className="space-y-6">
              <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                ...
                <CardContent>
                  <div className="text-center py-8">
                    <p className="text-gray-600 dark:text-gray-400">HBI Forecast Coach features coming soon...</p>
                  </div>
                </CardContent>
              </Card>
            </div>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading strategic opportunity intel...</p>
        </div>
      </div>
    )
  }
