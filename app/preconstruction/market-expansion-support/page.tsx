...
import { Globe, TrendingUp, MapPin, Building2 } from "lucide-react"
...
/**
 * Market Expansion Support Page Component
 */
export default function MarketExpansionSupportPage() {
  const { user } = useAuth()
  ...
  // Get tabs for market expansion support content
  const getTabsForContent = (): PageHeaderTab[] => {
    return [
      { id: "overview", label: "Overview" },
      { id: "market-analysis", label: "Market Analysis" },
      { id: "territory-planning", label: "Territory Planning" },
      { id: "expansion-strategy", label: "Expansion Strategy" },
    ]
  }
  ...
  const getHeaderConfig = () => {
    ...
    return {
      userName,
      moduleTitle: "Market Expansion Support",
      subHead: "Strategic support for expanding into new markets and territories",
      ...
      navigationState: {
        ...
        currentViewType: "market-expansion-support",
        ...
        <div className="space-y-6">
                ...
                <CardContent>
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                      Strategic support for expanding into new markets and territories. This module will provide
                      comprehensive market analysis, territory planning, and expansion strategies to drive growth into
                      new markets.
                    </p>
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="text-center">
                        <TrendingUp className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                        <h4 className="font-medium text-gray-900 dark:text-white">Market Analysis</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Market research and insights</p>
                      </div>
                      <div className="text-center">
                        <MapPin className="h-8 w-8 text-green-600 mx-auto mb-2" />
                        <h4 className="font-medium text-gray-900 dark:text-white">Territory Planning</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Geographic expansion planning</p>
                      </div>
                      <div className="text-center">
                        <Building2 className="h-8 w-8 text-purple-600 mx-auto mb-2" />
                        <h4 className="font-medium text-gray-900 dark:text-white">Expansion Strategy</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Strategic growth planning</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
          ...
          {activeTab === "market-analysis" && (
            <div className="space-y-6">
              <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                <CardHeader>
                  <CardTitle className="text-lg font-semibold text-gray-900 dark:text-white">Market Analysis</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-center py-8">
                    <p className="text-gray-600 dark:text-gray-400">Market analysis features coming soon...</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          {activeTab === "territory-planning" && (
            <div className="space-y-6">
              <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                ...
                <CardContent>
                  <div className="text-center py-8">
                    <p className="text-gray-600 dark:text-gray-400">Territory planning features coming soon...</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          {activeTab === "expansion-strategy" && (
            <div className="space-y-6">
              <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                ...
                <CardContent>
                  <div className="text-center py-8">
                    <p className="text-gray-600 dark:text-gray-400">Expansion strategy features coming soon...</p>
                  </div>
                </CardContent>
              </Card>
            </div>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading market expansion support...</p>
        </div>
      </div>
    )
  }
