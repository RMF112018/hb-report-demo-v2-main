 ...
 * Note: All roles now have the same access as project-manager for consistent UI experience
 */
export const ROLE_CATEGORY_ACCESS: Record<UserRole, string[]> = {
  executive: ["Financial Management", "Field Management", "Compliance", "Warranty"],
  "project-executive": ["Financial Management", "Field Management", "Compliance", "Warranty"],
  admin: ["Financial Management", "Field Management", "Compliance", "Warranty"],
  "project-manager": ["Financial Management", "Field Management", "Compliance", "Warranty"],
  estimator: ["Financial Management", "Field Management", "Compliance", "Warranty"],
  superintendent: ["Financial Management", "Field Management", "Compliance", "Warranty"],
  "team-member": ["Financial Management", "Field Management", "Compliance", "Warranty"],
  viewer: ["Financial Management", "Field Management", "Compliance", "Warranty"],
}
