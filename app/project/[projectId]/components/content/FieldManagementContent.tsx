        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Manage project scheduling, updates, and forecast planning</p>
            </div>
          </div>

          {/* Scheduler Sub-tabs */}
          <div className="space-y-4 w-full max-w-full overflow-hidden">
            <Tabs value={schedulerSubTab} onValueChange={setSchedulerSubTab} className="w-full">
              <TabsList className="grid w-full grid-cols-5">
                <TabsTrigger value="overview">Overview</TabsTrigger>
                <TabsTrigger value="project-schedule">Project Schedule</TabsTrigger>
                <TabsTrigger value="update">Update</TabsTrigger>
                <TabsTrigger value="look-ahead">Look Ahead</TabsTrigger>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Summary of current project schedule status</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                              ...
                              <p className="font-medium text-lg text-foreground">68%</p>
                            </div>
                            <div className="space-y-1">
                              <p className="text-xs text-muted-foreground uppercase tracking-wide">Days Remaining</p>
                              <p className="font-medium text-lg text-foreground">47</p>
                            </div>
                          </div>
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                              <p className="text-xs text-muted-foreground uppercase tracking-wide">Critical Tasks</p>
                              <p className="font-medium text-lg text-foreground">5</p>
                            </div>
                            <div className="space-y-1">
                              <p className="text-xs text-muted-foreground uppercase tracking-wide">Schedule Health</p>
                              <p className="font-medium text-lg text-green-600">Good</p>
                            </div>
                          </div>
                        </div>
                      </CardContent>
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>Latest schedule changes and updates</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-3">
                          <div className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                            <div className="flex-1">
                              <p className="text-sm font-medium">Foundation completed ahead of schedule</p>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <div className="flex-1">
                              <p className="text-sm font-medium">Next milestone scheduled</p>
              ...
              <TabsContent value="project-schedule" className="w-full max-w-full overflow-hidden">
                <div className="space-y-6 w-full max-w-full">
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                      ...
                      <CardDescription>Detailed project timeline and task management</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Project schedule interface will be implemented here with Gantt chart and task management tools.
                      </p>
                    </CardContent>
                  </Card>
                </div>
              ...
              <TabsContent value="update" className="w-full max-w-full overflow-hidden">
                <div className="space-y-6 w-full max-w-full">
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                      ...
                      <CardDescription>Update project schedule and task progress</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Schedule update interface will be implemented here with progress tracking and adjustment tools.
                      </p>
                    </CardContent>
                  </Card>
                </div>
              ...
              <TabsContent value="look-ahead" className="w-full max-w-full overflow-hidden">
                <div className="space-y-6 w-full max-w-full">
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                      ...
                      <CardDescription>Forecast and plan upcoming project activities</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Look ahead planning interface will be implemented here with forecasting and resource planning
                        tools.
                      </p>
                    </CardContent>
                  </Card>
              ...
              <TabsContent value="generator" className="w-full max-w-full overflow-hidden">
                <div className="space-y-6 w-full max-w-full">
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                      ...
                      <CardDescription>Generate and optimize project schedules</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Schedule generator interface will be implemented here with automated scheduling and optimization
                        tools.
                      </p>
                    </CardContent>
                  </Card>
