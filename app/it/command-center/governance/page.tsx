...
/**
 * Change Management & Governance Module
 * ------------------------------------
      ...
      <div className="space-y-3 p-6">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Change Management & Governance</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="sticky top-20 z-40 bg-white dark:bg-gray-950 border-b border-border/40 -mx-6 px-6 pb-4 backdrop-blur-sm">
          <div className="flex flex-col gap-4 pt-3" data-tour="change-management-header">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-foreground">Change Management & Governance</h1>
                  <p className="text-muted-foreground mt-1">
                    Manage IT governance processes, change approvals, and compliance policies
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Module Content */}
        <div data-tour="change-management-content">
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-border p-6">
            <div className="text-center py-12">
              <div className="mb-4">
                <div className="mx-auto w-16 h-16 bg-purple-100 dark:bg-purple-950/30 rounded-full flex items-center justify-center">
                  <Settings className="h-8 w-8 text-purple-600 dark:text-purple-400" />
                </div>
              </div>
              <h2 className="text-2xl font-bold text-foreground mb-2">Change Management & Governance</h2>
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Manage IT governance processes, change approvals, and compliance policies across all technology
              ...
              <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4 max-w-md mx-auto">
                <p className="text-amber-700 dark:text-amber-400 text-sm">
                  Change management dashboard coming soon. This will provide comprehensive governance workflows,
                  approval processes, and compliance tracking.
                </p>
              </div>
            </div>
          </div>
