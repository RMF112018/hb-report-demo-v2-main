...
import { EnhancedInteractiveStaffingGantt } from "../components/EnhancedInteractiveStaffingGantt"
...
import { Users, DollarSign, TrendingUp, AlertTriangle, FileText, Calendar, Settings } from "lucide-react"
            ...
            config={[
              {
                ...
                action:
                  "Consider reassigning Superintendents Johnson, Miller, and Davis to optimize project timelines.",
                confidence: 92,
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-2 border-t">
                ...
                <ul className="text-xs space-y-1 text-muted-foreground">
                  <li>
                    • Review {pendingSPCRs.length} pending SPCR{pendingSPCRs.length !== 1 ? "s" : ""}
                  </li>
